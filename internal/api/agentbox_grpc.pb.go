...
func (c *executionServiceClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecuteResponse], error) {
...
type ExecutionService_ExecuteClient = grpc.ServerStreamingClient[ExecuteResponse]
...
func (UnimplementedExecutionServiceServer) Execute(*ExecuteRequest, grpc.ServerStreamingServer[ExecuteResponse]) error {
...
func _ExecutionService_Execute_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ExecutionServiceServer).Execute(m, &grpc.GenericServerStream[ExecuteRequest, ExecuteResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ExecutionService_ExecuteServer = grpc.ServerStreamingServer[ExecuteResponse]
